...
#    y_data = 1 - y_data
    ...
    est_gp = SymbolicRegressor(population_size=1000,
                               ...
                               stopping_criteria=0.0, const_range=(-1, 1),
                               init_depth=(2, 6), init_method='half and half',
                               function_set=('add', 'sub', 'mul', 'neg', 'exp'), 
                               metric='rmse', parsimony_coefficient=0.005,
                               p_crossover=0.5, p_subtree_mutation=0.20, p_hoist_mutation=0.05,
                               p_point_mutation=0.20, p_point_replace=0.05,
                               max_samples=0.8, warm_start=False, low_memory=True,
